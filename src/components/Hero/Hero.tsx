        ...
        >
          ...
          >
            ...
            <div className="flex items-center divide-x-2 rtl:divide-x-reverse divide-gray-500 dark:divide-gray-700">
              <motion.cite
                className="pe-3 font-medium text-gray-900 dark:text-white"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
...
//         <h1 className="text-4xl md:text-9xl  font-bold text-center">
//           {data.title}
//         </h1>
//         <span className=" text-center font-thiin md:text-2xl mt-4">
//           {data.subtitle.map((line, index) => (
//         <p key={index}>{line}</p>
//       ))}
//         </span>
